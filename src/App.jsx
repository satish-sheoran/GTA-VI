...
function App() {
  ...
  useGSAP(() => {
    ...
    gsap.to(elem3, { scale: 1.4, bottom: '-13%', translateX: '-50%', duration: 1.8, delay: -0.9, ease: 'power4.easeInOut' }
    )
    gsap.fromTo(mainText, { rotate: '15deg', scale: 1.4 }, { scale: 1, rotate: 0, duration: 1.5,delay : -0.5, ease: 'power4.easeInOut' }
    )
